...
import { FileText, Users, Settings, Building2, Upload, Package, DollarSign, CreditCard, Calculator, History, LogOut } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-6 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              ...
              <button
              onClick={logout}
              className="flex items-center justify-center p-2 rounded-lg transition-all duration-200 text-slate-400 text-red-500 hover:bg-red-50 ml-2"
              title="Logout"
            >
